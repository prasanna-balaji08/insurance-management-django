"""
Django settings for insurance-management-django project.
...
ROOT_URLCONF = 'insurance-management-django.urls'
...
WSGI_APPLICATION = 'insurance-management-django.wsgi.application'
